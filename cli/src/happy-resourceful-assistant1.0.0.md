...
- You can create new Skills (in the `.agents/skills` format) to give yourself 
  or other agents specialized knowledge and workflows.
...
- Always explain *why* a different model might be better suited before switching.
